...
namespace ETicaretAPI.Infrastructure.Services
{
    public class MailService : IMailService
    {
        ...
        public async Task SendPasswordResetMailAsync(string to, string userId, string resetToken)
        {
            ...
            mail.AppendLine("\">Yeni şifre talebi için tıklayınız.</a></strong><br><br><span style=\"font-size:12px;\">Dikkat: Şifre yenileme işlemi tarafınızca gerçekleşmediyse lütfen bu mail'i dikkate almayınız.</span>");
